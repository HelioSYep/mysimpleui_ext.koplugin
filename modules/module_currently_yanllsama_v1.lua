...
local i18n = require("plugin_enhancements_i18n")
...
local Config       = SimpleUICompat.require("config")
local UI           = SimpleUICompat.require("core")
local SUISettings  = SimpleUICompat.require("store")
local PAD          = UI.PAD
...
local function getSUIStyle()
    if not _SUIStyle then
        local ok, m = SimpleUICompat.tryRequire("style")
